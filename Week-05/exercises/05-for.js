...
const palabras = ["Argentina", "Es", "Campeona", "Del", "Mundo"];
...
const palabrasMayus = ["argentina", "es", "campeona", "del", "mundo"];

for (let i = 0; i < palabrasMayus.length; i++) {
  const palabraConMayuscula = palabrasMayus[i].charAt(0).toUpperCase() + palabrasMayus[i].slice(1);
...
const cadenacompleta = ["Argentina", "Es", "Campeona", "Del", "Mundo"];
let sentence = "";
